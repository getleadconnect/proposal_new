                  ...
                  <a href="{{url()->previous()}}" class="btn btn-primary"><i class="fa fa-arrow-left"></i>&nbsp;Back</a>&nbsp;&nbsp;
					...
					<div class="card-body">
						...
						<div class="row">
							...
							<h6 class="">AddProposal Items: (<span style="color:red;font-size:12px;">*:-Required</span>)</h6>
				...
				<div class="card">
					<div class="card-body">
							...
							<div class="row">
							 ...
							 <h6 class="mb-2 mt-2">Add Customer Details:(<span style="color:red;font-size:12px;">*:-Required</span>)</h6>
