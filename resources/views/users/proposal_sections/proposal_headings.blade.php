							...
							<!-- Proposal PHASE headings --------->
								...
								<form  id="addHeading" >
										...
										<div class="row" >
											...
											<div class="col-6 col-lg-6 col-xl-6 col-xxl-6">
												<textarea class="form-control"  name="heading" id="heading"  placeholder="heading" required></textarea>
											</div>
						...
						<input type="hidden" name="head_id" id="head_id" >
							...
							<div class="row mb-2" >
								<div class="col-12 col-lg-12 col-xl-12 col-xxl-12">
									...
									<textarea rows=4 class="form-control"  name="heading_edit" id="heading_edit"  placeholder="heading" required></textarea>
								</div>
							</div>
