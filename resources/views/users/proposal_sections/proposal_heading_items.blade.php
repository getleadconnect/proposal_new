								...
								<form  id="addHeadingItem" >
										...
										<div class="row" >
											...
											<div class="col-5 col-lg-5 col-xl-5 col-xxl-5">
												<textarea class="form-control"  name="item_name" id="item_name"  placeholder="heading items" required></textarea>
											</div>
						...
						<input type="hidden" name="item_id" id="item_id" >
							...
							<div class="row mb-2" >
								<div class="col-12 col-lg-12 col-xl-12 col-xxl-12">
									...
									<textarea rows=4 class="form-control"  name="item_name_edit" id="item_name_edit"  placeholder="Item Name" required></textarea>
								</div>
							</div>
