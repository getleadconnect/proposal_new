...
<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
              <div class="breadcrumb-title pe-3">Proposal Options</div>
					   ...
					   <div class="row mt-3">
						...
						<div class=" align-items-start">
						  <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
							<button class="nav-link active text-left" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true"><i class="fa fa-caret-right"></i>&nbsp;&nbsp;Headings</button>
							<button class="nav-link text-left" id="v-pills-profile-tab" data-bs-toggle="pill" data-bs-target="#v-pills-profile" type="button" role="tab" aria-controls="v-pills-profile" aria-selected="false"><i class="fa fa-caret-right"></i>&nbsp;&nbsp;Heading Items</button>
							<button class="nav-link text-left" id="v-pills-messages-tab" data-bs-toggle="pill" data-bs-target="#v-pills-messages" type="button" role="tab" aria-controls="v-pills-messages" aria-selected="false"><i class="fa fa-caret-right"></i>&nbsp;&nbsp;Special Services</button>
							<button class="nav-link text-left" id="v-pills-settings-tab" data-bs-toggle="pill" data-bs-target="#v-pills-settings" type="button" role="tab" aria-controls="v-pills-settings" aria-selected="false"><i class="fa fa-caret-right"></i>&nbsp;&nbsp;Other Services</button>
							<button class="nav-link text-left" id="v-bank-details-tab" data-bs-toggle="pill" data-bs-target="#v-bank-details" type="button" role="tab" aria-controls="v-bank-details" aria-selected="false"><i class="fa fa-caret-right"></i>&nbsp;&nbsp;Bank Details</button>
							<button class="nav-link text-left" id="v-documents-required-tab" data-bs-toggle="pill" data-bs-target="#v-documents-required" type="button" role="tab" aria-controls="v-document-required" aria-selected="false"><i class="fa fa-caret-right"></i>&nbsp;&nbsp;Documents Required</button>
							<button class="nav-link text-left" id="v-process-timeline-tab" data-bs-toggle="pill" data-bs-target="#v-process-timeline" type="button" role="tab" aria-controls="v-process-timeline" aria-selected="false"><i class="fa fa-caret-right"></i>&nbsp;&nbsp;Process & Timeline</button>
							<button class="nav-link text-left" id="v-notes-tab" data-bs-toggle="pill" data-bs-target="#v-notes" type="button" role="tab" aria-controls="v-notes" aria-selected="false"><i class="fa fa-caret-right"></i>&nbsp;&nbsp;Notes</button>
							<button class="nav-link text-left" id="v-conditions-tab" data-bs-toggle="pill" data-bs-target="#v-conditions" type="button" role="tab" aria-controls="v-conditions" aria-selected="false"><i class="fa fa-caret-right"></i>&nbsp;&nbsp;Conditions</button>
						  </div>
						  </div>
						</div>
								...
								<form  id="addHeading" >
										...
										<div class="row" >
											<div class="col-2 col-lg-2 col-xl-2 col-xxl-2 col-form-label">
												<label for="Designation" class="form-label mb-2">Proposal Heading <span class="required">*</span></label>
											</div>
											<div class="col-6 col-lg-6 col-xl-6 col-xxl-6">
						...
						<!--TAB-2 ---- Heaing items ---------------------------------->	
							...
							<div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
								...
								<div class="row mt-3 pb-2 pt-2" style="background:#e4e4e4;">
								<div class="col-12 col-lg-12 col-xl-12 col-xxl-12">
								<form  id="addHeadingItem" >
										@csrf
										<div class="row" >
			
											<div class="col-2 col-lg-2 col-xl-2 col-xxl-2 col-form-label">
												<label for="item_name" class="form-label mb-2">Heading Items<span class="required">*</span></label>
											</div>
											<div class="col-5 col-lg-5 col-xl-5 col-xxl-5">
												<input type="text" class="form-control"  name="item_name" id="item_name"  placeholder="heading items" required>
											</div>
						...
						<!-- end -------------------->
									...
									<form  id="addSpecialService" >
											...
											<div class="row" >
												...
												<div class="col-7 col-lg-7 col-xl-7 col-xxl-7">
													<input type="text" class="form-control"  name="service_data" id="service_data"  placeholder="service data" required>
												</div>
								...
								<div class="col-12 col-lg-12 col-xl-12 col-xxl-12">
									<form  id="addOtherService" >
											...
											<div class="row" >
												...
												<div class="col-7 col-lg-7 col-xl-7 col-xxl-7">
													<input type="text" class="form-control"  name="other_service" id="other_service"  placeholder="service data" required>
												</div>
							...
							<div class="row pb-2 pt-2">
								<div class="col-12 col-lg-12 col-xl-12 col-xxl-12">
								<div class="table-responsive mt-3">
								 <table id="datatable3" class="table align-middle" style="width:100% !important;" >
								   <thead class="thead-semi-dark">
									 <tr>
										<th> SlNo</th>
										<th >Service</th>
						 ...
						 <div class="tab-pane fade" id="v-process-timeline" role="tabpanel" aria-labelledby="v-process-timeline-tab">
								...
								<div class="col-12 col-lg-12 col-xl-12 col-xxl-12">
									<form  id="addProcessTimeline" >
											...
											<div class="row" >
												...
												<div class="col-7 col-lg-7 col-xl-7 col-xxl-7">
													<input type="text" class="form-control"  name="timeline" id="timeline"  placeholder="timeline data" required>
												</div>
...
<!--- edit proposal headings------------------->
	 ...
	 <div class="modal fade" id="edit-heading-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style="display: none;">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<form  id="formUpdateHeading" >
						@csrf
						<input type="hidden" name="head_id" id="head_id" >
							
							<div class="row mb-2" >
								<div class="col-12 col-lg-12 col-xl-12 col-xxl-12">
									<label for="heading" class="form-label mb-2">Heading <span class="required">*</span></label>
									<input type="text" class="form-control"  name="heading_edit" id="heading_edit"  placeholder="heading" required>
								</div>
							</div>
	 ...
	 <div class="modal fade" id="edit-item-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style="display: none;">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="exampleModalLabel">Edit</h5>
					...
					<form  id="formUpdateHeadingItem" >
						@csrf
						<input type="hidden" name="item_id" id="item_id" >
							
							<div class="row mb-2" >
								<div class="col-12 col-lg-12 col-xl-12 col-xxl-12">
									<label for="item_name" class="form-label mb-2">Item Name <span class="required">*</span></label>
									<input type="text" class="form-control"  name="item_name_edit" id="item_name_edit"  placeholder="Item Name" required>
								</div>
							</div>
